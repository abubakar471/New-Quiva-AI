                ...
                <div className='p-10 rounded-3xl relative flex flex-col gap-y-4 w-full md:w-[600px] bg-transparent shadow-lg shadow-green-500'>
                    ...
                    <form onSubmit={handleSubmit} className='pt-10 flex flex-col gap-y-4'>
                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Name <span className='text-purple-500 text-lg'>*</span></p>
                            <input type="text" name="name" placeholder='Eg: John Doe' className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' required />
                        </div>

                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Email ID <span className='text-purple-500 text-lg'>*</span></p>
                            <input type="email" name="email" placeholder='Eg: john.doe@example.com' className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' required />
                        </div>

                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Company Name <span className='text-purple-500 text-lg'>*</span></p>
                            <input type="text" name="company" placeholder='Eg: Doe Enterprises' className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' required />
                        </div>

                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Website (Optional)</p>
                            <input type="url" name="website" placeholder='Eg: www.doeenterprises.com' className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' />
                        </div>

                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Plan <span className='text-purple-500 text-lg'>*</span></p>
                            <select name="plan" className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' required>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            <p className='text-sm flex text-gray-300 gap-2'>Billing Cycle <span className='text-purple-500 text-lg'>*</span></p>
                            <select name="billing" className='py-2 px-4 w-full text-sm text-gray-400 placeholder:text-gray-400/50 bg-gray-400/10 rounded-md outline-none focus:ring-2 focus:ring-purple-500/30 border-none transition-all duration-300 ease-in-out' required>
