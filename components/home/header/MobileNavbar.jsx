...
import { ArrowBigDownDashIcon, Facebook, Globe, Instagram, Linkedin, Menu, MenuSquare, Youtube } from 'lucide-react'
            ...
            <Modal>
                <ModalTrigger className="text-white flex justify-center group/modal-btn">
                    <span className="group-hover/modal-btn:translate-x-40 text-center transition duration-500">
                        <Menu width={120} height={80} className='text-white w-[40px]' />
                    </span>
                    <div className="-translate-x-40 group-hover/modal-btn:translate-x-0 flex items-center justify-center absolute inset-0 transition duration-500 text-white z-20">
                        <ArrowBigDownDashIcon width={120} height={80} className='text-white w-[40px]' />
                    </div>
                </ModalTrigger>
                <ModalBody>
                    <ModalContent>
                    ...
                    <ModalFooter className="gap-4">
                        {/* <div className="w-full flex items-center justify-center">
                            <Link href={""} className='text-white text-2xl bg-[#20BE72] px-12 py-1 md:py-3 rounded-full'>Train AI</Link>
                        </div> */}
                        ...
                        <div className="flex items-center gap-2 flex-wrap mr-4">
                            <Link href={"#"}>
                                <Facebook className="w-[]" />
                            </Link>
                            <Link href={"#"}>
                                <Instagram className="w-[]" />
                            </Link>
                            <Link href={"#"}>
                                <Youtube className="w-[]" />
                            </Link>
